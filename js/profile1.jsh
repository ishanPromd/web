...
function initializeClientSideEmailLists() {
    ...
    try {
        const listsToInit = [
            ...
            { key: LOCAL_STORAGE_ALLOWED_EMAILS_KEY, defaults: DEFAULT_ALLOWED_EMAILS_LOGIN, name: "Allowed" }
        ];
        ...
        showNotification("Error setting up initial email lists.", "error");
    }
}
...
function updateDashboardGreeting(userName) {
    ...
    const isGreetingPage = currentPath.endsWith('/home.html') || currentPath.endsWith('/home') || currentPath === '/';
